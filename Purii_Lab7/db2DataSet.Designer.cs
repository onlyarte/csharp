...
namespace Purii_Lab7 {
    ...
    public partial class db2DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FullName, string Position, string Department, decimal Salary) {
...
namespace Purii_Lab7.db2DataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`ID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `Position` IS NULL) OR (`Position` = ?)) AND ((? = 1 AND `Department` IS NULL) OR (`Department` = ?)) AND ((? = 1 AND `Salary` IS NULL) OR (`Salary` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`FullName`, `Position`, `Department`, `Salary`) VALUES (" +
                "?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `FullName` = ?, `Position` = ?, `Department` = ?, `Salary` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `Position` IS NULL) OR (`Position` = ?)) AND ((? = 1 AND `Department` IS NULL) OR (`Department` = ?)) AND ((? = 1 AND `Salary` IS NULL) OR (`Salary` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Purii_Lab7.Properties.Settings.Default.db2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FullName, [Position], Department, Salary FROM Employees";
        ...
        public virtual int Fill(db2DataSet.EmployeesDataTable dataTable) {
        ...
        public virtual db2DataSet.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            db2DataSet.EmployeesDataTable dataTable = new db2DataSet.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(db2DataSet.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_FullName, string Original_Position, string Original_Department, global::System.Nullable<decimal> Original_Salary) {
        ...
        public virtual int Insert(string FullName, string Position, string Department, global::System.Nullable<decimal> Salary) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, string Position, string Department, global::System.Nullable<decimal> Salary, int Original_ID, string Original_FullName, string Original_Position, string Original_Department, global::System.Nullable<decimal> Original_Salary) {
            if ((FullName == null)) {
